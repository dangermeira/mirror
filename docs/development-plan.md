...
> **Current status:** Phase 1, Step 6 (frontend connected to backend) ✅ done. **Next:** Step 7 — recent searches.
...
- [x] **5. Frontend: React + Tailwind shell** — scaffold the app, Tailwind working,
  search bar + empty dark layout. *Done when: the shell renders and Tailwind styles apply.*
- [x] **6. Frontend: connect to backend** — fetch + display real stats; loading + error
